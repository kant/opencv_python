...
inputImageFirst = cv.LoadImage('00000001.jpg', cv.CV_LOAD_IMAGE_GRAYSCALE)
inputImageSecond = cv.LoadImage('00000002.jpg', cv.CV_LOAD_IMAGE_GRAYSCALE)
...
desImageHS = cv.LoadImage('00000001.jpg', cv.CV_LOAD_IMAGE_COLOR)
desImageLK = cv.LoadImage('00000002.jpg', cv.CV_LOAD_IMAGE_COLOR)
